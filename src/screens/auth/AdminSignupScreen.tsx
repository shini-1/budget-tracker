...
export const AdminSignupScreen: React.FC = () => {
  ...
  const validateForm = () => {
    ...
    else if (formData.adminCode !== 'FOODVENTURER2025') newErrors.adminCode = 'Invalid admin access code';
  ...
  const handleSignup = async () => {
    ...
    try {
      ...
      if (registerUser.fulfilled.match(result)) {
        Alert.alert(
          'Success!',
          'Your admin account has been created! You will have access to the admin dashboard.',
          [
            {
              text: 'Continue',
              onPress: () => {
        ...
        Alert.alert('Error', result.payload as string || 'Failed to create admin account');
      }
    } catch (error: any) {
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.scrollContent}>
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>
          Create an admin account for Foodventurer
        </Text>
        <Text style={styles.warning}>
          ⚠️ Admin access requires special authorization
        </Text>
      </View>
      ...
      <View style={styles.form}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.inputGroup}>
            ...
            <TextInput
              ...
              placeholder="admin@foodventurer.com"
        ...
        <View style={styles.section}>
          ...
          <View style={styles.inputGroup}>
            ...
            <Text style={styles.hintText}>Contact system administrator for access code</Text>
          </View>
        </View>
